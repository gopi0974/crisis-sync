        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {role === 'guest' && (
            <>
              ...
              <div>
                <label className="block text-sm text-text-secondary mb-1">Room Number / Location</label>
                <input required type="text" value={room} onChange={e => setRoom(e.target.value)} className="w-full bg-dark-bg border border-card-border rounded-lg p-3 text-white focus:outline-none focus:border-primary-red" placeholder="e.g. 714 or Poolside" />
              </div>
            </>
          )}
